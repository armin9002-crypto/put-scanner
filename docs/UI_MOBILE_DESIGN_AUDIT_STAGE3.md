...
> **Historical audit note.** Portfolio Screenshot Import/OCR was subsequently retired. The screenshot-import row below records the former Stage 3 surface and is not supported current behavior.
