...
const REASON_COPY: Record<RecommendationReasonCode, string> = {
  ...
  CONDITIONAL_CREDIT_TOO_FAR: 'The required credit is too far above the credible executable market for a Conditional setup.',
  ...
  MARKET_INTEGRITY_INVALID: 'Canonical option-market integrity rejected the exact contract pricing.',
