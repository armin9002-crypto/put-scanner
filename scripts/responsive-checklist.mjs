...
const guardrails = [
  ...
  ['Historical Excel keeps option close and source underlying context visibly separate', sources.historicalExcel.includes('OPTION Close Price') && sources.historicalExcel.includes('context only, not persisted') && sources.historicalExcel.includes("' · ignored'")],
