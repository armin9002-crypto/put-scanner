...
const guardrails = [
  ...
  ['Portfolio exposes persistent Expiry/Underlying grouping and VIX-first schedule data', sources.portfolio.includes("['expiration', 'Expiry']") && sources.portfolio.includes('VIX @ Entry') && sources.portfolio.includes('Show OI / Volume') && sources.portfolio.includes('Realized IRR')],
