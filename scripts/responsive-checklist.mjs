...
const guardrails = [
  ...
  ['option detail shows both secured-cash and net-risk return families', sources.optionDetail.includes('Ann. Secured-Cash Yield') && sources.optionDetail.includes('Net-Risk Return')],
