...
const guardrails = [
  ...
  ['Portrait Option Chain keeps the real six-column header sticky in its route scroll owner', sources.options.includes('mobileOptionHeaderRef') && sources.options.includes('--mobile-option-chain-sticky-top') && sources.css.includes('.mobile-route-page') && sources.css.includes('height: 100dvh') && sources.css.includes('overflow-y: auto') && sources.css.includes('.mobile-option-chain-header') && sources.css.includes('position: -webkit-sticky') && sources.css.includes('top: var(--mobile-option-chain-sticky-top') && sources.css.includes('background: var(--bg-inset)')],
