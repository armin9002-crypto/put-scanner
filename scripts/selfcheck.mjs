...
const checks = [
  ...
  () => assertClose('zero premium is a valid nominal yield', calculateNominalYield(0, 50), 0),
  ...
  () => assertClose('expiration original nominal yield is Gross Risk aggregate', januaryScheduleGroup.originalNY, 500 / 14000),
  () => assertClose('expiration original annualized yield is Gross-Risk weighted', januaryScheduleGroup.originalAY, ((2 / 50 * 365 / 61) * 10000 + (1 / 40 * 365 / 45) * 4000) / 14000),
  () => assertClose('expiration current nominal yield is Gross Risk aggregate', januaryScheduleGroup.currentNY, 250 / 14000),
  () => assertClose('expiration current annualized yield is Gross-Risk weighted', januaryScheduleGroup.currentAY, (250 / 14000) * (365 / januaryScheduleGroup.dte)),
